...
class ProjectManagement
{
    public function route($app)
    {
        ...
        $app->post('/invoice/delete', function () use ($app) {
        ...
        $app->post('/ticket/priority', function () use ($app) {
        ...
        $app->post('/ticket/delete', function () use ($app) {
        ...
        $app->post('/ticket/close', function () use ($app) {
        ...
        $app->post('/ticket/comment', function () use ($app) {
        ...
        $app->post('/ticket/call', function () use ($app) {
