...
class Api
{
    public function route($app)
    {
        ...
        $app->get(
            '/api/:model/:type(/:pg(/:key(/:order)))', function ($model, $type, $pg = 1, $key = 'created', $order = 'asc') use ($app) {
        ...
        $app->get(
            '/api/:model/:id/show', function ($model, $id) use ($app) {
        ...
        $app->post(
            '/api/:model/save', function ($model) use ($app) {
        ...
        $app->post(
            '/api/:model/delete', function ($model) use ($app) {
         ...
         */
        $app->get(
            '/api/tree/:model(/:type)', function ($model, $type = null) use ($app) {
        ...
        $app->get(
            '/api/type(/:pg(/:key(/:order)))', function ($pg = 1, $key = 'name', $order = 'asc') use ($app) {
        ...
        $app->post(
            '/api/type/delete', function () use ($app) {
        ...
        $app->post(
            '/api/type/save', function () use ($app) {
        ...
        $app->get(
            '/api/area(/:pg(/:key(/:order)))', function ($pg = 1, $key = 'name', $order = 'asc') use ($app) {
        ...
        $app->get(
            '/api/area/:id/show', function ($id) use ($app) {
        ...
        $app->post(
            '/api/area/delete', function () use ($app) {
        ...
        $app->post(
            '/api/area/save', function () use ($app) {
        ...
        $app->get(
            '/api/block(/:pg(/:key(/:order)))', function ($pg = 1, $key = 'modified', $order = 'desc') use ($app) {
        ...
        $app->post(
            '/api/block/delete', function () use ($app) {
        ...
        $app->post(
            '/api/block/save', function () use ($app) {
        ...
        $app->get(
            '/api/user(/:pg(/:key(/:order)))', function ($pg = 1, $key = 'modified', $order = 'desc') use ($app) {
        ...
        $app->get(
            '/api/user/:id/show', function ($id) use ($app) {
        ...
        $app->get(
            '/api/user/profile', function ($id) use ($app) {
        ...
        $app->get(
            '/api/user/delete', function () use ($app) {
        ...
        $app->post(
            '/api/user/save', function () use ($app) {
         ...
         */
        $app->get(
            '/api/lang/:lang', function ($lang) use ($app) {
        ...
        $app->get(
            '/api/log(/:pg)', function ($pg = 1) use ($app) {
